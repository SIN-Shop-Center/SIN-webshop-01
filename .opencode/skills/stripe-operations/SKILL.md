...
- **Secret Key**: `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`
...
curl -s https://api.stripe.com/v1/charges?limit=5 \
  -u "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:" | python3 -m json.tool
```
...
curl -s -X POST https://api.stripe.com/v1/refunds \
  -u "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:" \

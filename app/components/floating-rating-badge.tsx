...
export function FloatingRatingBadge() {
  return (
    <a
      ...
      className="fixed bottom-4 right-4 z-40 hidden flex-col items-center gap-0.5 rounded-lg border border-border bg-card px-4 py-3 shadow-lg transition-transform hover:scale-105 md:flex"
    >

...
// Schedule: NOT a Worker route — run via VM cron: tooling/scripts/ops/sync-cj-images-vm.mjs
//
...
export async function GET(request: Request) {
  ...
  return NextResponse.json({
    info: 'Image sync must be triggered from the VM. Run: bash tooling/scripts/ops/sync-cj-images-cron.sh',

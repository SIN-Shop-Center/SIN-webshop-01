...
// The feed depends on live inventory and service-role credentials. Keep it out of
// build-time prerendering; CDN freshness is controlled by the response headers.

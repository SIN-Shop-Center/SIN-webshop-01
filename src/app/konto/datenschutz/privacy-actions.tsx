...
// Docs: src/lib/actions/privacy.ts

import { useState, useTransition } from 'react'
import { deleteMyAccount, exportMyData } from '@/lib/actions/privacy'
    ...
    <div className="flex flex-col gap-10">
      <section className="rounded-lg border border-border p-6">
        ...
        <p className="mb-4 text-sm text-muted-foreground leading-relaxed">
          Du erhältst eine JSON-Datei mit deinen Konto-, Bestell-, Kontakt-,
          Adress-, Newsletter- und Rücksendungsdaten. Der Link ist 15 Minuten gültig.
        </p>
        {downloadUrl ? (
          <a
            href={downloadUrl}

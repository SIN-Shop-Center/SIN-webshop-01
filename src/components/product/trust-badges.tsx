...
const BADGES = [
  { icon: TruckIcon, label: `Versandfrei ab ${formatEuro(SHIPPING.freeAboveCents)}` },
  { icon: RotateCcwIcon, label: '14 Tage Widerrufsrecht' },
  { icon: ShieldCheckIcon, label: 'Sicherer Stripe-Checkout' },
  { icon: Clock, label: `${SHIPPING.deliveryDaysMin}–${SHIPPING.deliveryDaysMax} Werktage` },
] as const

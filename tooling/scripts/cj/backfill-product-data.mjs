 ...
 *
 * Usage:
 *   node tooling/scripts/cj/backfill-product-data.mjs                 # nur Daten
 *   node tooling/scripts/cj/backfill-product-data.mjs --translate     # + deutsche Titel
 *   node tooling/scripts/cj/backfill-product-data.mjs --dry-run       # nur anzeigen
 *

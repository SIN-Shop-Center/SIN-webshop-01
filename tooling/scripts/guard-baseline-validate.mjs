...
const lineBaselinePath = join(ROOT, 'tooling', 'scripts', 'guard-lines-baseline.json')
const complexityBaselinePath = join(ROOT, 'tooling', 'scripts', 'guard-complexity-baseline.json')
const lineRules = [
  { ext: '.tsx', max: 180 },
  { ext: '.ts', max: 220 },
  { ext: '.go', max: 150 },

...
//
// Aufruf: node tooling/scripts/pipeline/trends-to-cj.mjs ./trends-output.json
// Output: ./cj-candidates.json — manuell reviewen, dann mit
//   node tooling/scripts/cj/import-products.mjs --from cj-candidates.json importieren.

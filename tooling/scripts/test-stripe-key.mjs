 ...
 *
 * Usage: node tooling/scripts/test-stripe-key.mjs
 */
...
if (json.error) {
  ...
  if (json.error.code === 'api_key_expired') {
    ...
    console.error('   → node tooling/scripts/deploy-cloudflare-secrets.mjs')
    console.error('   → node tooling/scripts/deploy-github-secrets.mjs')

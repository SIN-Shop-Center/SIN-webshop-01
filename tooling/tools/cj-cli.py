...
TOKEN_FILE = os.environ.get(
    "CJ_TOKEN_FILE", str(pathlib.Path.home() / ".cj-tokens.json")
)
...
def _load_tokens():
    ...
    if p.exists():
        try:
            ...
            pass
    return {
        "accessToken": os.environ.get("CJ_ACCESS_TOKEN", ""),
...
def _get_access_token():
    ...
    result = _api_call(
        "POST", "/authentication/getAccessToken", body={"apiKey": API_KEY}, no_auth=True
    )
...
def _refresh_access_token():
    ...
    if result.get("code") == 200 and result.get("data"):
        ...
        return tokens["accessToken"]
    print(
        f"Refresh failed ({result.get('code')}): {result.get('message')}. Getting new token...",
        file=sys.stderr,
    )
    tokens["accessToken"] = ""
    tokens["refreshToken"] = ""
...
def _api_call(method, path, body=None, params=None, no_auth=False, retry_auth=True):
    ...
    if not no_auth and result.get("code") == 1600001 and retry_auth:
        ...
        return _api_call(
            method, path, body=body, params=params, no_auth=no_auth, retry_auth=False
        )
        ...
        _save_tokens(
            {
                ...
                "accessTokenExpiryDate": result["data"].get(
                    "accessTokenExpiryDate", ""
                ),
                "refreshTokenExpiryDate": result["data"].get(
...
def cmd_auth_refresh_token(args):
    ...
    result = _api_call(
        "POST",
        "/authentication/refreshAccessToken",
        body={"refreshToken": tokens.get("refreshToken", "")},
        no_auth=True,
    )
    if result.get("code") == 200 and result.get("data"):
        t = _load_tokens()
...
def cmd_product_connect(args):
    _out(
        _api_call(
            "POST",
            "/product/connection/create",
            body={"productId": args.pid, "sku": args.sku, "storeSku": args.store_sku},
        )
    )
...
def cmd_product_disconnect(args):
    _out(
        _api_call(
            "DELETE", "/product/connection/delete", params={"productId": args.pid}
        )
    )
...
def cmd_pi_sku_list(args):
    ...
    _out(
        _api_call(
            "POST", "/product/stock/privateInventory/querySkuListByProductId", body=body
        )
    )
...
def cmd_pi_sku_detail(args):
    ...
    _out(
        _api_call(
            "POST", "/product/stock/privateInventory/querySkuDetailPage", body=body
        )
    )
...
def cmd_pi_sku_batch(args):
    ...
    _out(
        _api_call(
            "POST", "/product/stock/privateInventory/querySkuDetailListBySku", body=body
        )
    )
...
def cmd_pi_sku_flow(args):
    ...
    _out(
        _api_call(
            "POST", "/product/stock/privateInventory/querySkuFlowByCondition", body=body
        )
    )
...
def cmd_pi_warehouse_pictures(args):
    ...
    _out(
        _api_call(
            "POST",
            "/storehouseCenterWeb/syncStorehouseVideoRequests",
...
def cmd_order_create_v2(args):
    _out(
        _api_call("POST", "/shopping/order/createOrderV2", body=_build_order_body(args))
    )


def cmd_order_create_v3(args):
    _out(
        _api_call("POST", "/shopping/order/createOrderV3", body=_build_order_body(args))
    )
...
def cmd_order_add_cart(args):
    order_ids = args.order_ids.split(",")
    _out(
        _api_call("POST", "/shopping/order/addCart", body={"cjOrderIdList": order_ids})
    )
...
def cmd_order_add_cart_confirm(args):
    _out(
        _api_call(
            "POST", "/shopping/order/addCartConfirm", body={"orderId": args.order_id}
        )
    )
...
def cmd_order_detail(args):
    _out(
        _api_call(
            "GET", "/shopping/order/getOrderDetail", params={"orderId": args.order_id}
        )
    )
...
def cmd_order_delete(args):
    _out(
        _api_call("DELETE", "/shopping/order/delete", params={"orderId": args.order_id})
    )


def cmd_order_confirm(args):
    _out(
        _api_call("PATCH", "/shopping/order/confirm", params={"orderId": args.order_id})
    )
...
def cmd_order_change_warehouse(args):
    _out(
        _api_call(
            "POST",
            "/shopping/order/changeWarehouse",
            body={"orderId": args.order_id, "storageId": args.storage_id},
        )
    )
...
def cmd_order_sandbox_pay(args):
    _out(
        _api_call("POST", "/shopping/order/sandboxPay", body={"orderId": args.order_id})
    )
...
def cmd_order_sandbox_status(args):
    _out(
        _api_call(
            "POST",
            "/shopping/order/sandboxUpdateStatus",
            body={"orderId": args.order_id, "status": args.status},
        )
    )
...
def cmd_balance_pay_v2(args):
    order_ids = args.order_ids.split(",")
    _out(
        _api_call("POST", "/shopping/pay/payBalanceV2", body={"orderIdList": order_ids})
    )
...
def cmd_shipping_update_pod(args):
    ...
    _out(
        _api_call(
            "POST",
            "/shopping/shipping/updatePodPictures",
            body={"orderId": args.order_id, "imageUrlList": images},
        )
    )
...
def cmd_merge_auto_match(args):
    ...
    _out(
        _api_call(
            "POST",
            "/shopping/order/autoMatchMergeList",
            body={"orderIdList": order_ids},
        )
    )
...
def cmd_merge_auto_progress(args):
    _out(
        _api_call(
            "POST",
            "/shopping/order/autoMergeQueryProgress",
            body={"batchId": args.batch_id},
        )
    )
...
def cmd_merge_auto_result(args):
    _out(
        _api_call(
            "POST",
            "/shopping/order/autoMergeQueryResult",
            body={"batchId": args.batch_id},
        )
    )
...
def cmd_merge_submit_batch(args):
    ...
    _out(
        _api_call(
            "POST", "/shopping/order/submitMergeBatch", body={"orderIdList": order_ids}
        )
    )
...
def cmd_merge_submit_progress(args):
    _out(
        _api_call(
            "POST",
            "/shopping/order/submitMergeProgress",
            body={"batchId": args.batch_id},
        )
    )
...
def cmd_merge_submit_result(args):
    _out(
        _api_call(
            "POST", "/shopping/order/submitMergeResult", body={"batchId": args.batch_id}
        )
    )
...
def cmd_freight_calculate(args):
    products = _parse_json_or_file(args.products)
    body = {
        "startCountryCode": args.from_cc,
        "endCountryCode": args.to_cc,
        "products": products,
    }
...
def cmd_freight_calculate_tip(args):
    ...
    body = {
        "reqDTOS": [
            {
                "srcAreaCode": args.from_cc,
                "destAreaCode": args.to_cc,
...
def cmd_dispute_products(args):
    _out(
        _api_call("GET", "/disputes/disputeProducts", params={"orderId": args.order_id})
    )
...
def cmd_dispute_confirm(args):
    ...
    _out(
        _api_call(
            ...
            body={"orderId": args.order_id, "productInfoList": items},
        )
    )
...
def cmd_dispute_create(args):
    body = {
        "orderId": args.order_id,
        "businessDisputeId": args.business_id,
        "disputeReasonId": args.reason_id,
        "expectType": args.expect_type,
        "refundType": args.refund_type,
...
def cmd_dispute_cancel(args):
    _out(
        _api_call(
            "POST",
            "/disputes/cancel",
            body={"orderId": args.order_id, "disputeId": args.dispute_id},
        )
    )
...
def cmd_dispute_detail(args):
    _out(
        _api_call(
            "GET", "/disputes/getDisputeDetail", params={"disputeId": args.dispute_id}
        )
    )
...
def cmd_webhook_set(args):
    ...
    for topic in ["product", "stock", "order", "logistics"]:
        ...
        body[topic] = {
            "type": "ENABLE" if flag else "CANCEL",
...
def cmd_shop_save_variants(args):
    ...
    _out(
        _api_call(
            "POST", "/store/product/saveVariantBatch", body={"variants": variants}
        )
    )
...
def build_parser():
    parser = argparse.ArgumentParser(
        prog="cj-cli", description="CJ Dropshipping API CLI"
    )
    ...
    p = prod_sub.add_parser("categories")
    p.set_defaults(func=cmd_product_categories)

    p = prod_sub.add_parser("list")
    p.add_argument("--page-num", type=int)
    p.add_argument("--page-size", type=int)
    p.add_argument("--category-id")
    p.add_argument("--pid")
    p.add_argument("--product-sku")
    p.add_argument("--product-name")
    p.add_argument("--product-name-en")
    p.add_argument("--country-code")
    p.add_argument("--delivery-time")
    ...
    p = pi_sub.add_parser("sku-batch")
    p.add_argument("--sku", required=True)
    p.set_defaults(func=cmd_pi_sku_batch)

    p = pi_sub.add_parser("sku-flow")
    p.add_argument("--sku")
    p.add_argument("--page-num", type=int)
    p.add_argument("--page-size", type=int)
    p.set_defaults(func=cmd_pi_sku_flow)

    p = pi_sub.add_parser("warehouse-pictures")
    ...
    def _add_order_args(p):
        ...
        p.add_argument("--logistic-name", required=True)
        p.add_argument("--from-country-code", required=True)
        p.add_argument(
            "--products",
            required=True,
            help="JSON array or file path: [{vid,quantity}]",
        )
        p.add_argument("--shipping-zip")
        p.add_argument("--shipping-phone")
        p.add_argument("--shipping-address2")
        p.add_argument("--house-number")
        p.add_argument("--email")
        p.add_argument("--remark")
        p.add_argument("--tax-id")
        p.add_argument("--shop-amount", type=float)
        p.add_argument("--platform")
        p.add_argument("--ioss-type", type=int)
        p.add_argument("--ioss-number")
        p.add_argument("--pay-type", type=int)
        p.add_argument("--shop-logistics-type", type=int)
        p.add_argument("--storage-id")
        p.add_argument("--order-flow", type=int)
        p.add_argument("--store-name")

    p = order_sub.add_parser("create-v2")
    _add_order_args(p)
    p.set_defaults(func=cmd_order_create_v2)
    p = order_sub.add_parser("create-v3")
    _add_order_args(p)
    p.set_defaults(func=cmd_order_create_v3)

    p = order_sub.add_parser("add-cart")
    p.add_argument("--order-ids", required=True)
    p.set_defaults(func=cmd_order_add_cart)

    p = order_sub.add_parser("add-cart-confirm")
    p.add_argument("--order-id", required=True)
    p.set_defaults(func=cmd_order_add_cart_confirm)

    p = order_sub.add_parser("save-parent")
    p.add_argument("--order-ids", required=True)
    p.set_defaults(func=cmd_order_save_parent)

    p = order_sub.add_parser("list")
    p.add_argument("--page-num", type=int)
    p.add_argument("--page-size", type=int)
    p.set_defaults(func=cmd_order_list)

    p = order_sub.add_parser("detail")
    p.add_argument("--order-id", required=True)
    p.set_defaults(func=cmd_order_detail)

    p = order_sub.add_parser("delete")
    p.add_argument("--order-id", required=True)
    p.set_defaults(func=cmd_order_delete)

    p = order_sub.add_parser("confirm")
    p.add_argument("--order-id", required=True)
    p.set_defaults(func=cmd_order_confirm)

    p = order_sub.add_parser("change-warehouse")
    p.add_argument("--order-id", required=True)
    p.add_argument("--storage-id", required=True)
    p.set_defaults(func=cmd_order_change_warehouse)

    p = order_sub.add_parser("sandbox-pay")
    p.add_argument("--order-id", required=True)
    p.set_defaults(func=cmd_order_sandbox_pay)

    p = order_sub.add_parser("sandbox-status")
    p.add_argument("--order-id", required=True)
    ...
    p = merge_sub.add_parser("auto-match")
    p.add_argument("--order-ids", required=True)
    p.set_defaults(func=cmd_merge_auto_match)
    p = merge_sub.add_parser("auto-progress")
    p.add_argument("--batch-id", required=True)
    p.set_defaults(func=cmd_merge_auto_progress)
    p = merge_sub.add_parser("auto-result")
    p.add_argument("--batch-id", required=True)
    p.set_defaults(func=cmd_merge_auto_result)
    p = merge_sub.add_parser("submit-batch")
    p.add_argument("--order-ids", required=True)
    p.set_defaults(func=cmd_merge_submit_batch)
    p = merge_sub.add_parser("submit-progress")
    p.add_argument("--batch-id", required=True)
    p.set_defaults(func=cmd_merge_submit_progress)
    p = merge_sub.add_parser("submit-result")
    p.add_argument("--batch-id", required=True)
    p.set_defaults(func=cmd_merge_submit_result)

    # ── Freight ──
    freight = sub.add_parser("freight")
    freight_sub = freight.add_subparsers(dest="subcommand")
    p = freight_sub.add_parser("calculate")
    p.add_argument("--from", dest="from_cc", required=True)
    p.add_argument("--to", dest="to_cc", required=True)
    p.add_argument("--products", required=True)
    p.set_defaults(func=cmd_freight_calculate)
    p = freight_sub.add_parser("calculate-tip")
    p.add_argument("--from", dest="from_cc", required=True)
    p.add_argument("--to", dest="to_cc", required=True)
    p.add_argument("--products", required=True)
    p.set_defaults(func=cmd_freight_calculate_tip)
    p = freight_sub.add_parser("partner")
    p.add_argument("--order-num", required=True)
    p.add_argument("--country-code", required=True)
    p.add_argument("--country", required=True)
    p.add_argument("--province", required=True)
    ...
    p = freight_sub.add_parser("supplier-self")
    p.add_argument("--from", dest="from_cc", required=True)
    p.add_argument("--to", dest="to_cc", required=True)
    p.add_argument("--products", required=True)
    ...
    p = track_sub.add_parser("info")
    p.add_argument("--order-id", required=True)
    p.set_defaults(func=cmd_tracking_info)
    p = track_sub.add_parser("info-v2")
    p.add_argument("--order-id", required=True)
    p.set_defaults(func=cmd_tracking_info_v2)

    # ── Dispute ──
    disp = sub.add_parser("dispute")
    disp_sub = disp.add_subparsers(dest="subcommand")
    p = disp_sub.add_parser("products")
    p.add_argument("--order-id", required=True)
    p.set_defaults(func=cmd_dispute_products)
    p = disp_sub.add_parser("confirm")
    p.add_argument("--order-id", required=True)
    p.add_argument("--items", required=True)
    p.set_defaults(func=cmd_dispute_confirm)
    p = disp_sub.add_parser("create")
    p.add_argument("--order-id", required=True)
    p.add_argument("--business-id", required=True)
    p.add_argument("--reason-id", type=int, required=True)
    p.add_argument("--expect-type", type=int, required=True)
    p.add_argument("--refund-type", type=int, required=True)
    p.add_argument("--message", required=True)
    p.set_defaults(func=cmd_dispute_create)
    p = disp_sub.add_parser("cancel")
    p.add_argument("--order-id", required=True)
    p.add_argument("--dispute-id", required=True)
    p.set_defaults(func=cmd_dispute_cancel)
    p = disp_sub.add_parser("list")
    p.add_argument("--page-num", type=int)
    p.add_argument("--page-size", type=int)
    p.set_defaults(func=cmd_dispute_list)
    p = disp_sub.add_parser("detail")
    p.add_argument("--dispute-id", required=True)
    p.set_defaults(func=cmd_dispute_detail)

    # ── Webhook ──
    wh = sub.add_parser("webhook")
    wh_sub = wh.add_subparsers(dest="subcommand")
    p = wh_sub.add_parser("set")
    ...
    p = wh_sub.add_parser("subscribe")
    p.add_argument("--product-ids")
    p.add_argument("--subscribe-all", action="store_true")
    p.set_defaults(func=cmd_webhook_subscribe)
    p = wh_sub.add_parser("unsubscribe")
    p.add_argument("--product-ids", required=True)
    p.set_defaults(func=cmd_webhook_unsubscribe)
    p = wh_sub.add_parser("subscribed-list")
    p.add_argument("--page-num", type=int)
    p.add_argument("--page-size", type=int)
    p.set_defaults(func=cmd_webhook_subscribed_list)
    ...
    p = shop_sub.add_parser("save-product")
    p.add_argument("--id", required=True)
    p.add_argument("--title", required=True)
    p.add_argument("--image", required=True)
    p.add_argument("--description")
    p.set_defaults(func=cmd_shop_save_product)
    p = shop_sub.add_parser("save-variants")
